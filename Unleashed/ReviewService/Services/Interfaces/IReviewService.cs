...
namespace ReviewService.Services.Interfaces
{
    public interface IReviewService
    {
        ...
        Task<bool> UpdateReviewAsync(int id, UpdateReviewDto reviewDto, Guid currentUserId);
        ...
        Task<ReviewEligibilityResponseDto> GetReviewEligibilityAsync(Guid productId, Guid userId);
