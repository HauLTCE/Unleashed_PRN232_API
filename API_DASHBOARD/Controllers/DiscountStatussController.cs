...
namespace API_DASHBOARD.Controllers
{
    ...
    [ApiController]
    public class DiscountStatussController : ControllerBase
    {
        private readonly UnleashedContext _context;

        public DiscountStatussController(UnleashedContext context)
        {
            _context = context;
        }

        // GET: api/DiscountStatuss
        [HttpGet]
